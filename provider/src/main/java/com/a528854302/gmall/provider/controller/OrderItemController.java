...
import com.a528854302.gmall.provider.service.OrderItemService;
...
public class OrderItemController {
    ...
    //@RequiresPermissions("provider:orderitem:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("provider:orderitem:save")
    ...
    //@RequiresPermissions("provider:orderitem:update")
    ...
    //@RequiresPermissions("provider:orderitem:delete")
