 ...
 */
@RestController
@RequestMapping("provider/waresku")
public class WareSkuController {
    ...
    //@RequiresPermissions("provider:waresku:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("provider:waresku:save")
    ...
    //@RequiresPermissions("provider:waresku:update")
    ...
    //@RequiresPermissions("provider:waresku:delete")
